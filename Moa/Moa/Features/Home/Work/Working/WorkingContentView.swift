...
final class WorkingContentView: UIView {
    ...
    private var didTriggerConfetti = false
    ...
    func configure(
        ...
        let justFinished = (newIsFinished && !isFinished)
        ...
        if newIsFinished {
            ...
            if justFinished || !didTriggerConfetti {
                didTriggerConfetti = true
                earningsStackView.triggerConfetti()
            }
        } else {
            
            didTriggerConfetti = false
